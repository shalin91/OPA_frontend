...
const AddCommunity = () => {
  ...
  const { GetallDepartmentGroup, GetallLocation, GetallDepartmentType,GetallEmployeeRole,GetallEmployeeName,addCommMaster } =useContext(SignContext);
              ...
              <Formik
                ...
                onSubmit={(values, { resetForm }) => {
                    ...
                    console.log(">>>",selectedMulti2);
                     ...
                     console.log("dg1",dg1);    
                     console.log("en",en)               
                    addcommunitymaster(values.name,values.message,values.uploadimage,loc1,dg1,dt,er,en,values.isActive);
                  resetForm();
                }}
              >
                {({
